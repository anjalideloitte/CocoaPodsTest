...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/anjalideloitte/CocoaPodsTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'anjalideloitte' => 'anjaggarwal@deloitte.com' }
  s.source           = { :git => 'https://github.com/anjalideloitte/CocoaPodsTest.git', :tag => s.version.to_s }
